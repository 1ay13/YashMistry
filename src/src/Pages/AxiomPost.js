...
// import AP1 from "../../src/Data/ax.jpg";
// import AP2 from "../../src/Data/ax1.jpg";
// import AP3 from "../../src/Data/ax2.jpg";
// import AX01 from "../../src/Data/axiompost/AX01.jpg";
      ...
      <div className="hidden md:block w-full py-4 ">
        <div className="flex">
          <img
            ...
            src="/Img/axiompost/AX01.jpg"
            alt=""
          />
          <img
            className="flex-none w-2/3	 p-2 "
            src="/Img/axiompost/AX03.jpg"
            alt=""
          />
        </div>
        <div className="flex">
          <img
            className="flex-none w-2/3 p-2"
            src="/Img/axiompost/AX02.jpg"
            alt=""
          />
          <img
            className="flex-none w-1/3 p-2"
            src="/Img/axiompost/AX04.jpg"
            alt=""
          />
        </div>
      </div>
      ...
      <div className="w-full flex flex-col gap-8 py-0 md:py-4 bg-black text-white">
        ...
        <div>
          ...
          <div className="md:hidden w-[22%] md:w-[8%] justify-center gap-8 mx-auto my-10">
            <div className="flex md:block justify-center gap-6">
              <img src="/Img/aboutme/LOGO-US-SAILING-TEAM.jpg" alt="" />
              <img src="/Img/aboutme/LOGO-BGR.jpg" alt="" />
              <img src="/Img/aboutme/LOGO-TIY.jpg" alt="" />
            </div>
            <div className="flex md:block justify-center gap-6">
              <img src="/Img/aboutme/LOGO-VITALS.jpg" alt="" />
              <img src="/Img/aboutme/LOGO-HARKEN-DERM.jpg" alt="" />
            </div>
          </div>
        ...
        <div className=" border-zinc-800 border-b-2 mx-2">
          ...
          <div className="flex w-[25%] md:w-[8%] justify-center gap-8 mx-auto my-10">
            ...
            <img src="/Img/aboutme/LOGO-INDIEGOGO.jpg" alt="" />
          </div>
        </div>

        <div className="text-white flex justify-center gap-7">
          <div className="relative flex justify-center items-center shadow-md shadow-teal-500">
            <img src="/Img/axiompost/AXIOM-POST_BLOCK_01.jpg" alt="" />
          ...
          <div className="relative flex justify-center items-center shadow-md shadow-teal-500">
            <img src="/Img/axiompost/AXIOM-POST_BLOCK_02.jpg" alt="" />
            <p className="absolute z-10  bottom-48 font-bristone text-xl text-center">
              Remote <br /> Grading
            </p>
            <p className="absolute z-10  bottom-20 text-base px-5 text-center ">
              I work with clients across the globe, as DaVinci Resolve offers a
              remote video grading option. It allows two matching...
            </p>
            <Link
              to="/remotegrading"
              className="absolute bottom-2 font-bristone text-xs my-4  px-3 md:px-4 py-2  rounded-md bg-zinc-800 text-gray-200 hover:bg-teal-700"
